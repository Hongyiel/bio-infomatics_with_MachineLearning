...
# VGG 16
transfer_model = VGG16(weights='imagenet', include_top=False, input_shape=(120, 120, 3))
...
# model_tr = keras.models.Sequential()
# model_tr.add(transfer_model)
# model_tr.add(keras.layers.Flatten())
# model_tr.add(keras.layers.BatchNormalization())
# model_tr.add(keras.layers.Dense(32, activation='relu'))
# model_tr.add(keras.layers.Dropout(0.2))
# model_tr.add(keras.layers.BatchNormalization())
# model_tr.add(keras.layers.Dense(16, activation='relu' ))
# model_tr.add(keras.layers.Dropout(0.2))
# model_tr.add(keras.layers.BatchNormalization())
# model_tr.add(keras.layers.Dense(8, activation='relu' ))
# model_tr.add(keras.layers.Dropout(0.2))
# model_tr.add(keras.layers.BatchNormalization())
# model_tr.add(keras.layers.Dense(4, activation='softmax'))
...
loss,acuracy=model_tr.evaluate(test_image,test_label)
